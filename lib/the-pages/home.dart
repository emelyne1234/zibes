        ...
        child: Stack(
          children: [
                ...
                child: Stack(
                  children: [
                    Positioned(
                      ...
                      top: 113*fem,
                      child: Container(
                        padding: EdgeInsets.fromLTRB(51*fem, 3.93*fem, 44.5*fem, 3.86*fem),
                        width: 370*fem,
                        height: 40*fem,
                        decoration: BoxDecoration (
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              // line5WP2 (591:21)
                              margin: EdgeInsets.fromLTRB(0*fem, 0.07*fem, 14*fem, 0*fem),
                              width: 1*fem,
                              height: 32.14*fem,
                            ...
                            Center(
                              // searchherepPi (591:9)
                              child: Container(
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 132.5*fem, 0.07*fem),
                                child: Text(
                                  'Search here...',
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 168*fem, 5*fem),
                              width: 157*fem,
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.end,
                                children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration (
                                ...
                                border: Border.all(color: const Color(0xef204929)),
                    ...
                    Positioned(
                      ...
                      top: 222*fem,
                      child: Container(
                        padding: EdgeInsets.fromLTRB(9*fem, 7*fem, 11*fem, 15*fem),
                        width: 370*fem,
                        height: 279*fem,
                        decoration: BoxDecoration (
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              margin: EdgeInsets.fromLTRB(4*fem, 0*fem, 3*fem, 6*fem),
                              width: double.infinity,
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.end,
                                children: [
                            ...
                            Container(
                              ...
                              margin: EdgeInsets.fromLTRB(4*fem, 0*fem, 116.5*fem, 9*fem),
                              width: double.infinity,
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Container(
                                    // pinfillFHJ (595:75)
                                    margin: EdgeInsets.fromLTRB(0*fem, 1*fem, 13.5*fem, 0*fem),
                                    width: 14*fem,
                                    height: 15.9*fem,
                                    child: Image.asset(
                            ...
                            Container(
                              ...
                              margin: EdgeInsets.fromLTRB(4*fem, 0*fem, 186.5*fem, 0*fem),
                              width: double.infinity,
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.end,
                                children: [
            ...
            Positioned(
              ...
              top: 844*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(37.5*fem, 47*fem, 29*fem, 14*fem),
                width: 428*fem,
                height: 82*fem,
                decoration: BoxDecoration (
                ...
                child: Row(
                  ...
                  children: [
                    Center(
                      // homenrt (595:111)
                      child: Container(
                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 56.5*fem, 1*fem),
                        child: Text(
                          'Home',
                          textAlign: TextAlign.center,
                          style: SafeGoogleFont (
